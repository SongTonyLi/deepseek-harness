...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-settings-signin': { kind: 'none', reason: 'Browser-side sign-in surface; registers nothing model-facing.' },
  ...
  'packages/bundle/tui-app': { kind: 'none', reason: 'The terminal runner submits typed text as ordinary user messages; prompts and tools belong to the composed base and terminal rows.' },
  ...
  'packages/api/authorization-controller': { kind: 'none', reason: 'Sign-in conversation API owner; it registers no prompt, tool, or session event.' },
