...
export type { AuthorizationMethod, AuthorizationPromptOption, AuthorizationStatus } from '@deepseek-ai/dsh-authorization/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      agentPresetsRemote, authorizationControllerRemote, commandsRemote, settingsControllerRemote, accountRemote,
