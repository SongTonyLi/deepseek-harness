---
description: "LLM（大语言模型）能力包组：一个提供方无关的模型调用服务、DeepSeek、pi-ai 与 Cursor 提供方适配器、请求重试执行，以及具备回放感知的 token 计量。"
kind: "package-group"
---
...
| [`llm-cursor/`](llm-cursor/README.zh.md) | 通过 Cursor 订阅 PKCE 与非官方 Connect/protobuf HTTP/2 服务始终在线的 `cursor` 路由 | 注册到 `ctx.llm` |
